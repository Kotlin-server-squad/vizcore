...
class SessionLifecycleTest {
    ...
    @Test
    fun `retention policy removes expired sessions`() =
        runTest {
    ...
    @Test
    fun `retention policy enforces max session count`() =
        runTest {
            val baseTime = 100_000L
            var fakeClock = baseTime
            val policy =
    ...
    @Test
    fun `graceful shutdown clears all sessions`() =
        runTest {
    ...
    @Test
    fun `sessions have createdAtMs for TTL tracking`() =
        runTest {
    ...
    @Test
    fun `retention policy keeps non-expired sessions`() =
        runTest {
            val baseTime = 100_000L
