...
class SecurityHeadersTest {
    @Test
    fun `responses include X-Content-Type-Options header`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `responses include X-Frame-Options header`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `responses include X-XSS-Protection header`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `responses include Referrer-Policy header`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `responses include Permissions-Policy header`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `all security headers present on API endpoints`() =
        testApplication {
            application { module() }
