...
Items acknowledged and deferred at milestone v1.1 close on 2026-06-27:

| Category | Item | Status |
|----------|------|--------|
| onboarding (ONB-01) | ConnectWizard auto-resolve decoupled from the real VizcoreClient session — bind wizard to the app's session | open (tech-debt; pipeline unaffected) |
| verification | Phase 08.2 08.2-VERIFICATION.md | human_needed — superseded by 08.3 live UAT (passed) + 08.5 (Drawer retired) |
| quick_task | 260621-rgi-fix-quoted-db-url-default-in-application | unknown (v1.0/Phase-3 era) |
| todos | ~23 pending todos dated 2026-06-21/22 (cors-quoted-default, db-mode-empty-projection, share-ui-noop, wr-02-admin-cross-tenant-share, auth03-yaml-dollar-collision, +18 more) | open (v1.0/Phase-3-era tech-debt) |
| nyquist | VALIDATION.md missing for phases 07, 08.1, 08.2, 08.3, 08.4 | open (discovery-only; not a blocker) |

Full audit: `.planning/milestones/v1.1-MILESTONE-AUDIT.md`.
