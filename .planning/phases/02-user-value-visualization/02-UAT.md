...
number: 1
name: Real WebM record + playback end-to-end
expected: |
  Enter replay, click "Record replay as video" in the Export menu, and confirm a
  non-zero-duration .webm downloads and plays the full timeline at the chosen speed
  in Chrome/Firefox. In Safari, confirm the Record item is disabled with its tooltip (D-25).
