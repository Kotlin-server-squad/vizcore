# Requirements Archive: v1.1 Real-Code Coroutine Observability
...
- [x] **RCO-01**: A pluggable `InstrumentationSource` interface sits in front of the
...
- [x] **RCO-02**: A `DebugProbesSource` installs kotlinx `DebugProbes`
...
- [x] **RCO-03**: Each coroutine carries source attribution — function + `file:line` from
...
| RCO-01 | v1.1 (real-code obs) | Complete (Phase 06: InstrumentationSource interface + WrapperSource; 06-VERIFICATION 3/3) |
| RCO-02 | v1.1 (real-code obs) | Complete (Phase 06: DebugProbesSource poll/diff/synthesize; 06-VERIFICATION 3/3) |
| RCO-03 | v1.1 (real-code obs) | Complete (Phase 06 attribution + Phase 08.3 e2e surfacing; live UAT passed) |
...
| RCO-06 | v1.1 (real-code obs) | Complete (Phase 08 hierarchy/live-render + Phase 08.3 timeline source frames end-to-end; live Chrome UAT confirmed real file:line jump-to-code; 08-VERIFICATION 7/7, 08.3-VERIFICATION 11/11) |
| RCO-07 | v1.1 (real-code obs) | Complete (Phase 08: MetricsProjection active/peak/throughput/dispatcher-util/leaks + tenant-scoped GET /api/sessions/{id}/metrics + FE metrics panel/leak list; 08-VERIFICATION 7/7) |
